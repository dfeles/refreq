...
int receiveAudioBufferAndCallSimpleApp(void *outputBuffer, void *inputBuffer, unsigned int bufferSize,
	...
	if ( status ) std::cout << "aaa" << std::endl;
...
//---------------------------------------------------------
void ofSoundStream2Setup(int nOutputs, int nInputs, ofxNSWindowApp * OFSA){
	ofSoundStream2Setup(nOutputs, nInputs, OFSA, 44100, 256, 4);
}

//---------------------------------------------------------
void ofSoundStream2Setup(int nOutputs, int nInputs, int sampleRate, int bufferSize, int nBuffers){
	ofSoundStream2Setup(nOutputs, nInputs, NULL, sampleRate, bufferSize, nBuffers);
}

//---------------------------------------------------------
void ofSoundStream2Setup(int nOutputs, int nInputs, ofxNSWindowApp * OFSA, int sampleRate, int bufferSize, int nBuffers){
