...
//---------------------------------------------------------
void ofSoundStream2Setup(int nOutputs, int nInputs, ofBaseApp * OFSA){
...
//---------------------------------------------------------
void ofSoundStream2Setup(int nOutputs, int nInputs, ofBaseApp * OFSA, int sampleRate, int bufferSize, int nBuffers){
